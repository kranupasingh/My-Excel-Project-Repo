...
- **Formulas & Functions**
  ...
  - `UNIQUE` – extract distinct values in a dataset
...
- **Data Cleaning and Preparation**
  ...
  - Applied sorting (largest to smallest, alphabetical, custom)
...
<img width="876" height="389" alt="image" src="https://github.com/user-attachments/assets/18925438-d5c0-48a5-9b96-b1ad40c8e516" />

    <img width="876" height="525" alt="image" src="https://github.com/user-attachments/assets/231c1ac9-165e-4ace-96e1-cf14c7f516b2" />
...
I created multiple Pivot Tables to summarise:
  ...
  - Bike sales by country, age group, and gender
  - Device sales grouping by categories (e.g. product, region, month)
  - Calculating totals and averages dynamically

**Key Pivot Table skills demonstrated**
...
To make insights clear for visual storytelling of sales performance and presentation-ready, I used:
  ...
  - Conditional formatting (colour scales, value highlighting)
  - PivotCharts for interactive analysis for summarising trends
  - Custom formatting for currency, percentages, and categories

These visualisations were used to explain:
